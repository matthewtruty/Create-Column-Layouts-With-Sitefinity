...
Here are 3 easy ways you can include the JS with your dynamic module widget template.
  - CDN: `<script src="http://d35e7mkljnxl9p.cloudfront.net/sitefinity/createColumnLayout.1.0.min.js"></script>` NOTE: Make sure that jQuery is included before this script tag.
